...
RUN apt-get update -y && apt-get install -y clang-10 clang-tools-10 clang-10-doc libclang-common-10-dev libclang-10-dev libclang1-10 clang-format-10 python3-clang-10 clangd-10 lld-10 lldb-10 libfuzzer-10-dev
...
# Image signing
RUN apt-get update -y && apt-get install -y python-protobuf python3-protobuf
